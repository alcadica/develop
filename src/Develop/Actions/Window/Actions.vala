...
namespace Alcadica.Develop.Actions.Window {
	...
	public const string SHOW_EDITOR = "Alcadica.Actions.Window.SHOW_EDITOR";
	public const string SHOW_PROJECT_CREATION = "Alcadica.Actions.Window.SHOW_PROJECT_CREATION";
